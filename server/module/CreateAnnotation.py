...
def create_annotation():
    ...
    for i in range(0, fist_duration, 3):  # increment by 3 for every annotation
        annotations["onset"].append(fist_onset + i)
        annotations["duration"].append(3)  # each duration is now 3 seconds
    ...
    thumb_duration = 60
    for i in range(0, thumb_duration, 3):
        annotations["onset"].append(thumb_onset + i)
        annotations["duration"].append(3)
    ...
    index_duration = 60
    for i in range(0, index_duration, 3):
